...
a_tan=tan(9*pi/180);    %tan 9度对应的数值
num=size(t_zhen);

t=t_zhen(end-34:end); 
h=dis_zhen(end-34:end);
...
area_V1=13.0319*pi*0.5*1.5*pinshu1/10^7;
...
area_V3=13.0319*pi*0.5*2*pinshu2/10^7;

area_V2=13.0319*pi*0.7*0.7*(2.11-0.34);

%总的单位时间高压油输出的体积
area_out=(area_V1+area_V3+area_V2)/100;
V_in=area_out;          
